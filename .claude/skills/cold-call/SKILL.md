---
name: cold-call
description: Build Lance's daily cold-call list from HubSpot for the Aircall Power Dialer, plus the mandatory Daily call brief docx and its 7am ET email. Use for ANY ask that involves a list of phone numbers from HubSpot, a dial string, the daily dials, a call list, a call brief, who to call today, or the cold-call routine. This file is the complete spec; read it in full before touching HubSpot.
---

# Cold-call phone list (HubSpot seller outreach)

Moved verbatim from `CLAUDE.md` on 2026-09-11 so it loads only when a cold-call ask comes in. Nothing below changed in the move. It remains the recurring "50 phone numbers from HubSpot" routine spec; follow all of it without being asked.
